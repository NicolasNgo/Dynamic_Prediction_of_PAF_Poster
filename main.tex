...
\title{\textbf{Prédiction dynamique de la fibrillation atriale paroxystique à l'aide de modèles conjoints et de données longitudinales du sample entropy}}
...
\logoright{\includegraphics[height=6.3cm]{sesstim-umr1252-tutelles.png}}
